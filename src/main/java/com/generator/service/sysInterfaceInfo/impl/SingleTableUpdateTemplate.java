...
public class SingleTableUpdateTemplate {

    private static String createFilePath(String tableName) {
        String path = System.getProperty("user.dir");
        String filePath = path + File.separator + tableName + "_edit" + ".xlsx";
        return filePath;
    }
    ...
    private static void createSheet1TemplateHeader(String tableName, List<ExcelCell> cells) throws Exception {
        ...
        //第二列
        String[] secondRow = {tableName, "", UnderlineToCamelUtils.underlineToCamel(tableName, true), "editBean", "edit"};
